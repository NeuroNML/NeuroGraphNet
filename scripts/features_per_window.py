if __name__ == "__main__":
    ...
    print("X_train:", X_train.shape) #  (N, n_channels, n_windows, n_features)
    print("X_test:", X_test.shape)

    # ------------------------- Save arrays ---------------------------------------------#
    np.save(DATA_ROOT / "extracted_features/X_window_test", X_test)
    np.save(DATA_ROOT / "extracted_features/X_window_train.npy", X_train)
