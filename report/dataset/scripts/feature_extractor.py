if __name__ == "__main__":
    ...
    # ------------------------- Save arrays ---------------------------------------------#
    np.save(LOCAL_DATA_ROOT / "extracted_features/X_test_DE.npy", X_test)
    np.save(LOCAL_DATA_ROOT / "extracted_features/X_train_DE.npy", X_train)
    np.save(
        LOCAL_DATA_ROOT / "extracted_features/sample_subject_array.npy", sample_subject_list
    )
